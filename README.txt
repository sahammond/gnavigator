...
Usage:
gnavigator.py [-h] [-p PREFIX] [-d DB_DIR] [-n DB_NAME] [-t THREADS] [-m GENETIC_MAP] cDNA genome
...
executable, you may specify it in the file "gnavigator-paths.txt" as in the example provided there.
